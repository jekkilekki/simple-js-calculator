...
importScripts();	// bring up our dependencies for this project
window.onload = run;
 ...
 *	IMPORT SCRIPTS
 *	
 *	Adds to <head> the other scripts that are necessary for the calculator.js to run.
 */
function importScripts() {
	var scripts = [ "calculator-inputHandler", 
 ...
 *
 * @link: http://www.kirupa.com/html5/keyboard_events_in_javascript.htm
